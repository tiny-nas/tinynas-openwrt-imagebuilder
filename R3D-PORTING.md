...
### P1 先让它启动（1–2 个周末）
- [ ] 本地源码构建：`openwrt v25.12.5` + cherry-pick PR #14373
- [ ] DTS 6.6→6.12 适配（预计 90% 直接可用；卡点大概率在 SATA/PHY/emc2305 节点）
...
| 风险 | 概率 | 影响 | 对策 |
|------|------|------|------|
| DTS 6.12 适配卡壳（qcom 结构大改） | 中 | P1 延期 | PR 已用 qcom/ 新结构，起点好；卡住可先锁 24.10（kernel 6.6，DTS 免移植）出第一版 |
