...
| target 路径 | `malta-be` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/malta-be/openwrt-imagebuilder-25.12.5-malta-be.Linux-x86_64.tar.xz) |
| 架构族 | malta |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/malta-be/openwrt-imagebuilder-25.12.5-malta-be.Linux-x86_64.tar.xz
