...
TinyNAS 锦盒在 **Broadcom BCM47xx 路由器**（bcm47xx-legacy）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `bcm47xx-legacy` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/bcm47xx-legacy/openwrt-imagebuilder-25.12.5-bcm47xx-legacy.Linux-x86_64.tar.xz) |
| 架构族 | bcm47xx |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/bcm47xx-legacy/openwrt-imagebuilder-25.12.5-bcm47xx-legacy.Linux-x86_64.tar.xz
