...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `kirkwood-generic` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/kirkwood-generic/openwrt-imagebuilder-25.12.5-kirkwood-generic.Linux-x86_64.tar.xz) |
| 架构族 | kirkwood |

## 典型硬件

Marvell Kirkwood NAS。
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/kirkwood-generic/openwrt-imagebuilder-25.12.5-kirkwood-generic.Linux-x86_64.tar.xz
