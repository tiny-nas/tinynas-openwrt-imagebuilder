...
TinyNAS 简盒在 **高通 IPQ50xx/60xx/807x 高端路由器**（qualcommax-ipq807x）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `qualcommax-ipq807x` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/qualcommax-ipq807x/openwrt-imagebuilder-25.12.5-qualcommax-ipq807x.Linux-x86_64.tar.xz) |
| 架构族 | qualcommax |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/qualcommax-ipq807x/openwrt-imagebuilder-25.12.5-qualcommax-ipq807x.Linux-x86_64.tar.xz
