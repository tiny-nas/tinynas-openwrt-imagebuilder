...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `qualcommax-ipq50xx` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/qualcommax-ipq50xx/openwrt-imagebuilder-25.12.5-qualcommax-ipq50xx.Linux-x86_64.tar.xz) |
| 架构族 | qualcommax |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/qualcommax-ipq50xx/openwrt-imagebuilder-25.12.5-qualcommax-ipq50xx.Linux-x86_64.tar.xz
