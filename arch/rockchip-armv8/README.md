...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `rockchip-armv8` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/rockchip-armv8/openwrt-imagebuilder-25.12.5-rockchip-armv8.Linux-x86_64.tar.xz) |
| 架构族 | rockchip |

## 典型硬件

瑞芯微 RK3328/RK3399/RK3568 等 ARMv8 SBC。
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/rockchip-armv8/openwrt-imagebuilder-25.12.5-rockchip-armv8.Linux-x86_64.tar.xz
