...
TinyNAS 锦盒在 **Lantiq xRX/xWAY DSL 路由器**（lantiq-xrx200）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `lantiq-xrx200` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/lantiq-xrx200/openwrt-imagebuilder-25.12.5-lantiq-xrx200.Linux-x86_64.tar.xz) |
| 架构族 | lantiq |

## 典型硬件

Lantiq xRX/xWAY DSL 路由器。
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/lantiq-xrx200/openwrt-imagebuilder-25.12.5-lantiq-xrx200.Linux-x86_64.tar.xz
