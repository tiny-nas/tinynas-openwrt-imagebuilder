...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `microchipsw-lan969x` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/microchipsw-lan969x/openwrt-imagebuilder-25.12.5-microchipsw-lan969x.Linux-x86_64.tar.xz) |
| 架构族 | microchipsw |

## 典型硬件

Microchip LAN969x 交换机。
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/microchipsw-lan969x/openwrt-imagebuilder-25.12.5-microchipsw-lan969x.Linux-x86_64.tar.xz
