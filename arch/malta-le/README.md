...
TinyNAS 简盒在 **MIPS Malta 评估板**（malta-le）架构下的打包配置。
...
| target 路径 | `malta-le` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/malta-le/openwrt-imagebuilder-25.12.5-malta-le.Linux-x86_64.tar.xz) |
| 架构族 | malta |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/malta-le/openwrt-imagebuilder-25.12.5-malta-le.Linux-x86_64.tar.xz
