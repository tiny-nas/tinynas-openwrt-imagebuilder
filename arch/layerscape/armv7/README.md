...
TinyNAS 锦盒在 **NXP Layerscape 服务器级 ARM**（layerscape-armv7）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `layerscape-armv7` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/layerscape-armv7/openwrt-imagebuilder-25.12.5-layerscape-armv7.Linux-x86_64.tar.xz) |
| 架构族 | layerscape |

## 典型硬件

NXP Layerscape 服务器级 ARM。
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/layerscape-armv7/openwrt-imagebuilder-25.12.5-layerscape-armv7.Linux-x86_64.tar.xz
