...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `layerscape-armv8_64b` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/layerscape-armv8_64b/openwrt-imagebuilder-25.12.5-layerscape-armv8_64b.Linux-x86_64.tar.xz) |
| 架构族 | layerscape |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/layerscape-armv8_64b/openwrt-imagebuilder-25.12.5-layerscape-armv8_64b.Linux-x86_64.tar.xz
