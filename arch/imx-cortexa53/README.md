...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `imx-cortexa53` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/imx-cortexa53/openwrt-imagebuilder-25.12.5-imx-cortexa53.Linux-x86_64.tar.xz) |
| 架构族 | imx |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/imx-cortexa53/openwrt-imagebuilder-25.12.5-imx-cortexa53.Linux-x86_64.tar.xz
