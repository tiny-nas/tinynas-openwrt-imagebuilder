# arch/ipq40xx/chromium

TinyNAS 简盒在 **高通 IPQ40xx 路由器**（ipq40xx-chromium）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `ipq40xx-chromium` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/ipq40xx-chromium/openwrt-imagebuilder-25.12.5-ipq40xx-chromium.Linux-x86_64.tar.xz) |
| 架构族 | ipq40xx |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/ipq40xx-chromium/openwrt-imagebuilder-25.12.5-ipq40xx-chromium.Linux-x86_64.tar.xz
