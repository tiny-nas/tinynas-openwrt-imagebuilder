...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `tegra-generic` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/tegra-generic/openwrt-imagebuilder-25.12.5-tegra-generic.Linux-x86_64.tar.xz) |
| 架构族 | tegra |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/tegra-generic/openwrt-imagebuilder-25.12.5-tegra-generic.Linux-x86_64.tar.xz
