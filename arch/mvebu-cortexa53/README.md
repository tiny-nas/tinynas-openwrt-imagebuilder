...
TinyNAS 锦盒在 **Marvell ARMADA 38x/37x/70xx 路由器**（mvebu-cortexa53）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `mvebu-cortexa53` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/mvebu-cortexa53/openwrt-imagebuilder-25.12.5-mvebu-cortexa53.Linux-x86_64.tar.xz) |
| 架构族 | mvebu |

## 典型硬件

Marvell ARMADA 38x/37x/70xx 路由器。
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/mvebu-cortexa53/openwrt-imagebuilder-25.12.5-mvebu-cortexa53.Linux-x86_64.tar.xz
