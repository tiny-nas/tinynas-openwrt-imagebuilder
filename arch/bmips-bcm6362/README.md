...
TinyNAS 简盒在 **Broadcom BMIPS（运营商光猫）**（bmips-bcm6362）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `bmips-bcm6362` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/bmips-bcm6362/openwrt-imagebuilder-25.12.5-bmips-bcm6362.Linux-x86_64.tar.xz) |
| 架构族 | bmips |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/bmips-bcm6362/openwrt-imagebuilder-25.12.5-bmips-bcm6362.Linux-x86_64.tar.xz
