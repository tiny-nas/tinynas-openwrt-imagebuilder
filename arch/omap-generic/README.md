...
TinyNAS 锦盒在 **TI OMAP**（omap-generic）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `omap-generic` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/omap-generic/openwrt-imagebuilder-25.12.5-omap-generic.Linux-x86_64.tar.xz) |
| 架构族 | omap |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/omap-generic/openwrt-imagebuilder-25.12.5-omap-generic.Linux-x86_64.tar.xz
