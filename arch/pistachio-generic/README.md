...
TinyNAS 简盒在 **ImgTec Pistachio**（pistachio-generic）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `pistachio-generic` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/pistachio-generic/openwrt-imagebuilder-25.12.5-pistachio-generic.Linux-x86_64.tar.xz) |
| 架构族 | pistachio |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/pistachio-generic/openwrt-imagebuilder-25.12.5-pistachio-generic.Linux-x86_64.tar.xz
