...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `lantiq-xrx200_legacy` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/lantiq-xrx200_legacy/openwrt-imagebuilder-25.12.5-lantiq-xrx200_legacy.Linux-x86_64.tar.xz) |
| 架构族 | lantiq |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/lantiq-xrx200_legacy/openwrt-imagebuilder-25.12.5-lantiq-xrx200_legacy.Linux-x86_64.tar.xz
