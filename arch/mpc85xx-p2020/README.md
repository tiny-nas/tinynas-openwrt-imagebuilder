...
TinyNAS 锦盒在 **Freescale P10xx/P20xx PowerPC**（mpc85xx-p2020）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `mpc85xx-p2020` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/mpc85xx-p2020/openwrt-imagebuilder-25.12.5-mpc85xx-p2020.Linux-x86_64.tar.xz) |
| 架构族 | mpc85xx |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/mpc85xx-p2020/openwrt-imagebuilder-25.12.5-mpc85xx-p2020.Linux-x86_64.tar.xz
