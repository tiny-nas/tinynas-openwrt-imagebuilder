...
TinyNAS 锦盒在 **Allwinner ARM9/A7/A8/A53 SBC**（sunxi-cortexa8）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `sunxi-cortexa8` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/sunxi-cortexa8/openwrt-imagebuilder-25.12.5-sunxi-cortexa8.Linux-x86_64.tar.xz) |
| 架构族 | sunxi |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/sunxi-cortexa8/openwrt-imagebuilder-25.12.5-sunxi-cortexa8.Linux-x86_64.tar.xz
