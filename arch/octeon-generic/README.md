...
TinyNAS 锦盒在 **Cavium Octeon MIPS64**（octeon-generic）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `octeon-generic` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/octeon-generic/openwrt-imagebuilder-25.12.5-octeon-generic.Linux-x86_64.tar.xz) |
| 架构族 | octeon |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/octeon-generic/openwrt-imagebuilder-25.12.5-octeon-generic.Linux-x86_64.tar.xz
