...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `sifiveu-generic` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/sifiveu-generic/openwrt-imagebuilder-25.12.5-sifiveu-generic.Linux-x86_64.tar.xz) |
| 架构族 | sifiveu |

## 典型硬件

SiFive U54/U74 RISC-V。
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/sifiveu-generic/openwrt-imagebuilder-25.12.5-sifiveu-generic.Linux-x86_64.tar.xz
