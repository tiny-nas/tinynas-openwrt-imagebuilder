...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `mediatek-mt7622` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/mediatek-mt7622/openwrt-imagebuilder-25.12.5-mediatek-mt7622.Linux-x86_64.tar.xz) |
| 架构族 | mediatek |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/mediatek-mt7622/openwrt-imagebuilder-25.12.5-mediatek-mt7622.Linux-x86_64.tar.xz
