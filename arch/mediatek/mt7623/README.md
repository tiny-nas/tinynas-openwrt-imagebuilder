...
TinyNAS 锦盒在 **MediaTek Filogic/MT7622/MT7623/MT7629 路由器**（mediatek-mt7623）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `mediatek-mt7623` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/mediatek-mt7623/openwrt-imagebuilder-25.12.5-mediatek-mt7623.Linux-x86_64.tar.xz) |
| 架构族 | mediatek |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/mediatek-mt7623/openwrt-imagebuilder-25.12.5-mediatek-mt7623.Linux-x86_64.tar.xz
