# arch/ipq806x/chromium

TinyNAS 简盒在 **高通 IPQ806x 路由器**（ipq806x-chromium）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `ipq806x-chromium` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/ipq806x-chromium/openwrt-imagebuilder-25.12.5-ipq806x-chromium.Linux-x86_64.tar.xz) |
| 架构族 | ipq806x |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/ipq806x-chromium/openwrt-imagebuilder-25.12.5-ipq806x-chromium.Linux-x86_64.tar.xz
