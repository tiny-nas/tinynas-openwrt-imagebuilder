...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `bcm4908-generic` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/bcm4908-generic/openwrt-imagebuilder-25.12.5-bcm4908-generic.Linux-x86_64.tar.xz) |
| 架构族 | bcm4908 |

## 典型硬件

Broadcom BCM4908 路由器。
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/bcm4908-generic/openwrt-imagebuilder-25.12.5-bcm4908-generic.Linux-x86_64.tar.xz
