...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `qoriq-generic` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/qoriq-generic/openwrt-imagebuilder-25.12.5-qoriq-generic.Linux-x86_64.tar.xz) |
| 架构族 | qoriq |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/qoriq-generic/openwrt-imagebuilder-25.12.5-qoriq-generic.Linux-x86_64.tar.xz
