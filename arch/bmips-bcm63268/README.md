...
TinyNAS 锦盒在 **Broadcom BMIPS（运营商光猫）**（bmips-bcm63268）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `bmips-bcm63268` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/bmips-bcm63268/openwrt-imagebuilder-25.12.5-bmips-bcm63268.Linux-x86_64.tar.xz) |
| 架构族 | bmips |

## 典型硬件

Broadcom BMIPS（运营商光猫）。
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/bmips-bcm63268/openwrt-imagebuilder-25.12.5-bmips-bcm63268.Linux-x86_64.tar.xz
