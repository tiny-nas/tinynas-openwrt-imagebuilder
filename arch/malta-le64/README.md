...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `malta-le64` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/malta-le64/openwrt-imagebuilder-25.12.5-malta-le64.Linux-x86_64.tar.xz) |
| 架构族 | malta |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/malta-le64/openwrt-imagebuilder-25.12.5-malta-le64.Linux-x86_64.tar.xz
