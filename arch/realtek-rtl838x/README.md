# arch/realtek-rtl838x

TinyNAS 简盒在 **Realtek RTL838x/RTL839x 交换机**（realtek-rtl838x）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `realtek-rtl838x` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/realtek-rtl838x/openwrt-imagebuilder-25.12.5-realtek-rtl838x.Linux-x86_64.tar.xz) |
| 架构族 | realtek |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/realtek-rtl838x/openwrt-imagebuilder-25.12.5-realtek-rtl838x.Linux-x86_64.tar.xz
