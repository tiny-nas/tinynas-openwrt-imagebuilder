...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `gemini-generic` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/gemini-generic/openwrt-imagebuilder-25.12.5-gemini-generic.Linux-x86_64.tar.xz) |
| 架构族 | gemini |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/gemini-generic/openwrt-imagebuilder-25.12.5-gemini-generic.Linux-x86_64.tar.xz
