...
TinyNAS 简盒在 **Microchip AT91 SAM9/SAMA5/SAMA7**（at91-sama5）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `at91-sama5` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/at91-sama5/openwrt-imagebuilder-25.12.5-at91-sama5.Linux-x86_64.tar.xz) |
| 架构族 | at91 |

## 典型硬件

Microchip AT91 SAM9/SAMA5/SAMA7。
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/at91-sama5/openwrt-imagebuilder-25.12.5-at91-sama5.Linux-x86_64.tar.xz
