...
TinyNAS 锦盒在 **MediaTek MT7620/MT7621/MT76x8/RT305x/RT3883 路由器**（ramips-mt7620）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `ramips-mt7620` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/ramips-mt7620/openwrt-imagebuilder-25.12.5-ramips-mt7620.Linux-x86_64.tar.xz) |
| 架构族 | ramips |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/ramips-mt7620/openwrt-imagebuilder-25.12.5-ramips-mt7620.Linux-x86_64.tar.xz
