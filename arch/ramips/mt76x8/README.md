...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `ramips-mt76x8` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/ramips-mt76x8/openwrt-imagebuilder-25.12.5-ramips-mt76x8.Linux-x86_64.tar.xz) |
| 架构族 | ramips |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/ramips-mt76x8/openwrt-imagebuilder-25.12.5-ramips-mt76x8.Linux-x86_64.tar.xz
