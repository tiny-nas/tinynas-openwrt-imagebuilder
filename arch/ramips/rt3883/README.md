...
TinyNAS 简盒在 **MediaTek MT7620/MT7621/MT76x8/RT305x/RT3883 路由器**（ramips-rt3883）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `ramips-rt3883` |
| 默认 PROFILE | `rt3883` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/ramips-rt3883/openwrt-imagebuilder-25.12.5-ramips-rt3883.Linux-x86_64.tar.xz) |
| 架构族 | ramips |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/ramips-rt3883/openwrt-imagebuilder-25.12.5-ramips-rt3883.Linux-x86_64.tar.xz
