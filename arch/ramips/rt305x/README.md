...
TinyNAS 简盒在 **MediaTek MT7620/MT7621/MT76x8/RT305x/RT3883 路由器**（ramips-rt305x）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `ramips-rt305x` |
| 默认 PROFILE | `rt305x` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/ramips-rt305x/openwrt-imagebuilder-25.12.5-ramips-rt305x.Linux-x86_64.tar.xz) |
| 架构族 | ramips |

## 典型硬件

MediaTek MT7620/MT7621/MT76x8/RT305x/RT3883 路由器。
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/ramips-rt305x/openwrt-imagebuilder-25.12.5-ramips-rt305x.Linux-x86_64.tar.xz
