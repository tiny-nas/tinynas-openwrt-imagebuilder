...
TinyNAS 简盒在 **ARMv8 软路由（x86 类通用）**（armsr-armv8）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `armsr-armv8` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/armsr-armv8/openwrt-imagebuilder-25.12.5-armsr-armv8.Linux-x86_64.tar.xz) |
| 架构族 | armsr |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/armsr-armv8/openwrt-imagebuilder-25.12.5-armsr-armv8.Linux-x86_64.tar.xz
