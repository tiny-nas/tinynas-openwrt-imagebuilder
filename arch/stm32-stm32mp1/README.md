...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `stm32-stm32mp1` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/stm32-stm32mp1/openwrt-imagebuilder-25.12.5-stm32-stm32mp1.Linux-x86_64.tar.xz) |
| 架构族 | stm32 |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/stm32-stm32mp1/openwrt-imagebuilder-25.12.5-stm32-stm32mp1.Linux-x86_64.tar.xz
