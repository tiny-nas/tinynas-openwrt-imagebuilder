...
TinyNAS 简盒在 **Broadcom BCM53xx 路由器**（bcm53xx-generic）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `bcm53xx-generic` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/bcm53xx-generic/openwrt-imagebuilder-25.12.5-bcm53xx-generic.Linux-x86_64.tar.xz) |
| 架构族 | bcm53xx |

## 典型硬件

Broadcom BCM53xx 路由器。
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/bcm53xx-generic/openwrt-imagebuilder-25.12.5-bcm53xx-generic.Linux-x86_64.tar.xz
