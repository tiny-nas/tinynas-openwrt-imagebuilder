...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `apm821xx-nand` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/apm821xx-nand/openwrt-imagebuilder-25.12.5-apm821xx-nand.Linux-x86_64.tar.xz) |
| 架构族 | apm821xx |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/apm821xx-nand/openwrt-imagebuilder-25.12.5-apm821xx-nand.Linux-x86_64.tar.xz
