# arch/starfive-generic

TinyNAS 锦盒在 **StarFive JH7100/VisionFive**（starfive-generic）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `starfive-generic` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/starfive-generic/openwrt-imagebuilder-25.12.5-starfive-generic.Linux-x86_64.tar.xz) |
| 架构族 | starfive |

## 典型硬件

StarFive JH7100/VisionFive。
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/starfive-generic/openwrt-imagebuilder-25.12.5-starfive-generic.Linux-x86_64.tar.xz
