...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `ixp4xx-generic` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/ixp4xx-generic/openwrt-imagebuilder-25.12.5-ixp4xx-generic.Linux-x86_64.tar.xz) |
| 架构族 | ixp4xx |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/ixp4xx-generic/openwrt-imagebuilder-25.12.5-ixp4xx-generic.Linux-x86_64.tar.xz
