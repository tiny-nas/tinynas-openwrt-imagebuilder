...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `siflower-sf21` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/siflower-sf21/openwrt-imagebuilder-25.12.5-siflower-sf21.Linux-x86_64.tar.xz) |
| 架构族 | siflower |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/siflower-sf21/openwrt-imagebuilder-25.12.5-siflower-sf21.Linux-x86_64.tar.xz
