...
TinyNAS 锦盒在 **AMCC APM821xx NAS/路由器**（apm821xx-sata）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `apm821xx-sata` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/apm821xx-sata/openwrt-imagebuilder-25.12.5-apm821xx-sata.Linux-x86_64.tar.xz) |
| 架构族 | apm821xx |

## 典型硬件

AMCC APM821xx NAS/路由器。
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/apm821xx-sata/openwrt-imagebuilder-25.12.5-apm821xx-sata.Linux-x86_64.tar.xz
