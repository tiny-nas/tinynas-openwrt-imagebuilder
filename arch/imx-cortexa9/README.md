...
TinyNAS 简盒在 **NXP i.MX 6/7/8 SBC**（imx-cortexa9）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `imx-cortexa9` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/imx-cortexa9/openwrt-imagebuilder-25.12.5-imx-cortexa9.Linux-x86_64.tar.xz) |
| 架构族 | imx |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/imx-cortexa9/openwrt-imagebuilder-25.12.5-imx-cortexa9.Linux-x86_64.tar.xz
