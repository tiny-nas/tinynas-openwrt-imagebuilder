...
TinyNAS 锦盒在 **全志 D1 (RISC-V)**（d1-generic）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `d1-generic` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/d1-generic/openwrt-imagebuilder-25.12.5-d1-generic.Linux-x86_64.tar.xz) |
| 架构族 | d1 |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/d1-generic/openwrt-imagebuilder-25.12.5-d1-generic.Linux-x86_64.tar.xz
