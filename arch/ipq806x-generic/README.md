...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `ipq806x-generic` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/ipq806x-generic/openwrt-imagebuilder-25.12.5-ipq806x-generic.Linux-x86_64.tar.xz) |
| 架构族 | ipq806x |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/ipq806x-generic/openwrt-imagebuilder-25.12.5-ipq806x-generic.Linux-x86_64.tar.xz
