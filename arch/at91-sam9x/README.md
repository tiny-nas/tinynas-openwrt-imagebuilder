...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `at91-sam9x` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/at91-sam9x/openwrt-imagebuilder-25.12.5-at91-sam9x.Linux-x86_64.tar.xz) |
| 架构族 | at91 |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/at91-sam9x/openwrt-imagebuilder-25.12.5-at91-sam9x.Linux-x86_64.tar.xz
