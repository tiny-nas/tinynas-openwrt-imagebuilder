...
TinyNAS 锦盒在 **树莓派 1-5（bcm2708/2709/2710/2711/2712）**（bcm27xx-bcm2711）架构下的打包配置。
...
|---|---|
| OpenWrt 版本 | 25.12.5 |
| target 路径 | `bcm27xx-bcm2711` |
| 默认 PROFILE | `generic` |
| Image Builder | [下载链接](https://downloads.openwrt.org/releases/25.12.5/targets/bcm27xx-bcm2711/openwrt-imagebuilder-25.12.5-bcm27xx-bcm2711.Linux-x86_64.tar.xz) |
| 架构族 | bcm27xx |
...
- Image Builder: https://downloads.openwrt.org/releases/25.12.5/targets/bcm27xx-bcm2711/openwrt-imagebuilder-25.12.5-bcm27xx-bcm2711.Linux-x86_64.tar.xz
